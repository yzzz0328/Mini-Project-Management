...
// Lam Ting Le
public class AdminLecturerSortedProjectsView {
    ...
    String[][] tableData = loadProjectDetails(); // 2D array to store table data
    ...
    // Lam Ting Le
    // Constructs a default AdminLecturerSortedProjectsView object
    public AdminLecturerSortedProjectsView() throws IOException {
        ...
        JLabel filterLabel = new JLabel("Filter by Lecturer Name (Case Sensitive):");
